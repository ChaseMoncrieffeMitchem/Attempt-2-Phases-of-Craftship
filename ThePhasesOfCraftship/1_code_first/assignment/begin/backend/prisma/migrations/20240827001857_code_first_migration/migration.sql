...
-- CreateIndex
CREATE UNIQUE INDEX "Users Table_email_key" ON "Users Table"("email");

-- CreateIndex
CREATE UNIQUE INDEX "Users Table_username_key" ON "Users Table"("username");

-- CreateIndex
CREATE UNIQUE INDEX "Member_userId_key" ON "Member"("userId");

-- AddForeignKey
ALTER TABLE "Member" ADD CONSTRAINT "Member_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Users Table"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
